  ...
  return h("div", { className: "dshh-settings" }, [
    ...
    h("section", { className: "dshh-panel" }, [
      ...
      h("div", { className: "dshh-actions" }, [
        ...
        h("button", { className: "dshh-btn", disabled: busy, onClick: () => doTest("complete") }, "测试完成通知"),
        h("button", { className: "dshh-btn", disabled: busy, onClick: () => doTest("confirm") }, "测试确认通知"),
        h("button", { className: "dshh-btn", disabled: busy, onClick: () => doTest("permission") }, "测试授权通知"),
      ]),
      h("div", { className: "dshh-hint" }, "三个测试按钮分别对应三类真实通知：完成（含提示音）、多选一确认（ask_user_question）、工具授权审批（approval/request）。通知走 PowerShell WinRT Toast（零依赖）；音效走 PowerShell + WPF MediaPlayer（随包内置一段合成提示音，可自定义本地文件并调音量）。若桌面收不到通知，请检查「专注助手 / 勿扰」是否拦截。"),
    ]),
